...
<div class="container beta-relative">
    ...
    <div class="container">
        <form action="{{ route('admin-edit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img id="preview-image-before-upload" src="{{ asset('image/product/' . $products->image) }}" alt="preview image" style="max-height: 250px;">
            ...
            <div class="form-group">
                ...
                <textarea name="editDescription" id="editDescription" required>{{ $products->description }}</textarea>
                <script>
